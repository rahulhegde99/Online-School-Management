                    ...
                    <div class="row  ">
                        ...
                        <div class="col-12">
                            <div class="container border rounded ">
                                ...
                                <hr/>
                                <form class="form-group" action="notice.htm" method="post" >
                            ...
                            <div class="container border rounded">
                                ...
                                <c:forEach var="notices" items="${nts}">
                                    <a class="list-group-item list-group-item-action" href="/SpringMvcLogin/update_notice.htm?n_id=${notices.n_id}">
                                        <div>
                                            <h4>&Rrightarrow; ${notices.n_title}</h4>
                                            Description : ${notices.n_description}<br/>
