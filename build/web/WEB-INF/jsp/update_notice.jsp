            ...
            <div class="row">
                <div class="col-2 col-md-2">
                    ...
                    <div class="list-group">
                        ...
                        <a href="notice.htm" class="list-group-item list-group-item-action active">Notice</a>
                ...
                <div class="col-7 col-md-7">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <br/>
                            <h3>Update Notice</h3>
                            <form class="form-group" action="update_notice.htm" method="post" >
                                <c:forEach var="notice" items="${notice}">
                                    
                                     <label>Notice id :</label>
                                     <input class="form-control" type="text" name="n_id" value="${notice.n_id}"/><br/>
                                     
                                    <label>Notice Title :</label>
                                    <input class="form-control" type="text" name="n_title" value="${notice.n_title}"/><br/>
                                    
                                    <label>Notice Description :</label>
                                    <textarea class="form-control" type="text" name="n_description">${notice.n_description} </textarea><br/>
                                    
                                    <label>Publish Date :</label>
                                    <input class="form-control" value="<fmt:formatDate value="${notice.publish_date}" pattern="yyyy-MM-dd" />" disabled="true" /><br/>
                                    
                                </c:forEach>
                                    <input class="btn btn-lg" type="submit" value="Update"> <input class="btn btn-lg"  type="button" value="Delete"/>
                                </form>
                        </div>
                    </div>   
                    </div>
