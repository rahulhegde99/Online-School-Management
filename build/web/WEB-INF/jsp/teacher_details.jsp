            ...
            <div class="row">
                <div class="col-2 col-md-2">
                    ...
                    <div class="list-group">
                        <a href="index.htm" class="list-group-item list-group-item-action active ">Home</a>
                        ...
                        <a href="all_teachers" class="list-group-item list-group-item-action active ">Teachers Information</a>
...
<%--                                    <td>
                                        <img style="width:80px;height:80px" class="img-thumbnail" src="resource/images/${tcr.t_name}_${tcr.phone_number}.jpg" 
                                             alt="resource/images/${tcr.t_name}_${tcr.phone_number}.jpg"
                                             />  
                                    </td>--%>