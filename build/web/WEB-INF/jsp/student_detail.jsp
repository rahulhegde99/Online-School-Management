            ...
            <div class="row">
                <div class="col-2 col-md-2">
                    ...
                    <div class="list-group">
                        ...
                        <a href="studentsInfo.htm" class="list-group-item list-group-item-action active">Students Information</a>
                ...
                <div class="col-7 col-md-7">
                    ...
                    <form class="form-group" action="" method="">
                        ...
                        <input class="form-control"  type="text" name="sa_date" value="${std.s_name}" disabled="true" /> 
                        <h6 class="modal-title">roll_no </h6> 
                        <input class="form-control" type="text" name="s_id" value="${std.roll_no}" disabled="true" /> 
                        <h6 class="modal-title">Gender</h6> 
                        <input class="form-control" type="text" name="s_id" value="${std.gender}" disabled="true" /> 
                        <h6 class="modal-title">Date of Birth</h6> 
                        <input class="form-control" type="text" name="s_id" value="${std.dob}" disabled="true" /> 
                        <h6 class="modal-title">Age</h6> 
                        <input class="form-control" type="text" name="s_id" value="${std.age}" disabled="true"/> 
                        <h6 class="modal-title">father Name</h6> 
                        <input class="form-control" type="text" name="s_id" value="${std.f_name}" disabled="true"/> 
                        <h6 class="modal-title">Mother Name</h6> 
                        <input class="form-control" type="text" name="s_id" value="${std.m_name}" disabled="true"/> 
                        <h6 class="modal-title">Mobile No</h6> 
                        <input class="form-control" type="text" name="s_id" value="${std.mobile_no}" disabled="true"/> 
                        <h6 class="modal-title">Present Address</h6> 
                        <input class="form-control" type="text" name="s_id" value="${std.present_address}" disabled="true"/> 
                        <h6 class="modal-title">Permanent Address</h6> 
                        <input class="form-control" type="text" name="s_id" value="${std.Permanent_address}" disabled="true"/>
                        </c:forEach>
                    </form>
                    </div>
