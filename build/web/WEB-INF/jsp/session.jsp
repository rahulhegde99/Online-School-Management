            ...
            <div class="row">
                <div class="col-2 col-md-2">
                   ...
                   <div class="list-group">
                        ...
                        <a href="session.htm" class="list-group-item list-group-item-action active">Session</a>
                    ...
                    <div class="row">
                        <div class="col-12" >
                            <div  class="container border rounded">
                                <form class="form-group" action="session.htm" method="post" >
                                    <h1>Create Sessions</h1>
                                    <hr/>
                                    <br/>
                                    <label>Session Year :</label>
                                    <input class="form-control" type="text" name="sess_year" placeholder="2000-01"/><br/>
                                    <input type="submit">
                                </form>
                            </div>
                            <br/>
                            <div  class="container border rounded">
                                ...
                                <table class="table">
                                    ...
                                    <c:forEach var="session" items="${sns}"> 
                                        <tr>
                                            <td>${session.sess_id}</td>
                                            <td>${session.sess_year}</td>
