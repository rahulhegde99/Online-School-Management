            ...
            <div class="row">
                <div class="col-2 col-md-2">
                    ...
                    <div class="list-group">
                        ...
                        <a href="subject.htm" class="list-group-item list-group-item-action active">Subject</a>                        
                    ...
                    <div class="row">
                        <div class="col-12" >
                            <div class="container border rounded">
                                <form class="form-group" action="subject.htm" method="post" >
                                    <h1>Create New Subject</h1><hr/>
                                    <label>Subject Name :</label>
                                    <input class="form-control" type="text" name="sub_name" placeholder="English"/><br/>
                                    <input type="submit">
                                </form>
                            </div>
                            <br/>
                            <div class="container border rounded">
                                ...
                                <table class="table">
                                    ...
                                    <c:forEach var="subject" items="${sns}"> 
                                        <tr>
