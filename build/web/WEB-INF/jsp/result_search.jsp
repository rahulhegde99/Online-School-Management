...
<html>
    ...
    String grade;
        ...
        gPoint = (marks >= 80) ? 5 : (marks >= 70) ? 4 : (marks >= 60) ? 3.5 : (marks >= 50) ? 3 : (marks >= 40) ? 2 : (marks >= 30) ? 1 : 0;
        grade = (marks >= 80) ? "A+" : (marks >= 70) ? "A" : (marks >= 60) ? "A-" : (marks >= 50) ? "B" : (marks >= 40) ? "C" : (marks >= 30) ? "D" : "F";
                    --%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <form class="form-group" method="" action="">
                                ...
                                <input class="form-control" type="number" name="s_id"/>
                                <br/>
                                <input type="submit"/>
                            </form>
                            <br/>
                            <div>
                                <center>
                                    <c:forEach var="smt" items="${smtr}">
                                        <label><h3> ${smt.sem_name} Exam</h3></label>
                                    </c:forEach>
                                    <br>
                                    <c:forEach var="student" items="${std}">                               
                                        <label><h4>Name : ${student.s_name}</h4></label><br/>
                                        <label><h5>Student Id : ${student.s_id}</h5></label><br/>
                                        <label><h5>Roll No : ${student.roll_no}</h5></label>                               
                                    </c:forEach>
                                </center>
                            </div>
                            <br>
...
//                gPoint = (marks >= 80) ? 5 : (marks >= 70) ? 4 : (marks >= 60) ? 3.5 : (marks >= 50) ? 3 : (marks >= 40) ? 2 : (marks >= 30) ? 1 : 0;
//                grade = (marks >= 80) ? "A+" : (marks >= 70) ? "A" : (marks >= 60) ? "A-" : (marks >= 50) ? "B" : (marks >= 40) ? "C" : (marks >= 30) ? "D" : "F";
//                document.getElementById("gp").innerHTML = gPoint;
