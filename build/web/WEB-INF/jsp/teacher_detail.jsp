            ...
            <div class="row">
                ...
                <div class="col-7 col-md-7">
                    ...
                    <div class="container border rounded ">
                        <form class="form-group" action="teacher_detail" method="post">
                            <c:forEach var="tcr" items="${tcr}">
                                ...
                                <center>
                                 ...
                                 <h6 class="modal-title">Teacher Id </h6>
                                <input class="form-control"  type="text" name="t_id" value="${tcr.t_id}"  />        
                                <h6 class="modal-title">Teacher Name </h6>
                                <input class="form-control"  type="text" name="t_name" value="${tcr.t_name}"  /> 
                                <h6 class="modal-title">Email </h6> 
                                <input class="form-control" type="text" name="t_email" value="${tcr.t_email}" /> 
                                <h6 class="modal-title">Gender</h6> 
                                <input class="form-control" type="text" name="gender" value="${tcr.gender}" /> 
                                <h6 class="modal-title">Phone Number</h6> 
                                <input class="form-control" type="text" name="p_number" value="${tcr.phone_number}" /> 
                                <h6 class="modal-title">Address</h6> 
                                <textarea class="form-control" type="text" name="t_address"> ${tcr.address}</textarea> 
                                <h6 class="modal-title">Subject Name</h6> 
                                <input class="form-control" type="text" name="sub_id" value="${tcr.sub_name}" /> 
                                <h6 class="modal-title">Join Date</h6> 
                                <input class="form-control" type="text" name="join_date" value="${tcr.join_date}" /> <br/>
