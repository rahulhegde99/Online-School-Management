            ...
            <div class="row">
                <div class="col-2 col-md-2">
                    ...
                    <div class="list-group">
                        <a href="teacherHome.htm" class="list-group-item list-group-item-action active">Teacher Home</a>
                ...
                <div class="col-7 col-md-7">
                    ...
                    <div class="row container">
                        <div class="cl-6">
                             <br/>
                            <button class="btn btn-lg"><a href="/OnlineSchoolManagementSystem/noticeBoard.htm">Notice Board</a></button> 
                            <button class="btn btn-lg"><a href="/OnlineSchoolManagementSystem/attendance.htm">Attendance</a></button>
                            <br>                           
                        </div>
                        <div class="cl-6">
                             <br/>
                            <button class="btn btn-lg"><a href="/OnlineSchoolManagementSystem/result.htm">Result</a></button> 
                            <button class="btn btn-lg"><a href="/OnlineSchoolManagementSystem/studentsInfo.htm">Student Information</a></button>
                            <br>
                        </div>
                    </div>
