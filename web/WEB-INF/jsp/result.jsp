            ...
            <div class="row">
                ...
                <div class="col-7 col-md-7">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <button class="btn btn-lg"><a href="/OnlineSchoolManagementSystem/add_result.htm">Add Result</a></button> 
                             <button class="btn btn-lg"><a href="/OnlineSchoolManagementSystem/result_search.htm">Search Result</a></button>
                            <br><br/>
