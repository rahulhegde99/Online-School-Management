            ...
            <div class="row">
                <div class="col-2 col-md-2">
                    ...
                    <div class="list-group">
                        ...
                        <a href="search_result.htm" class="list-group-item list-group-item-action active">Search Result</a>
                        <a href="teachers_info.htm" class="list-group-item list-group-item-action">Teachers Information</a>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <c:forEach var="student" items="${std}">                               
                                ...
                                <label><h6>Student Id : ${student.s_id}</h6></label><br/>
                                <label><h6>Roll No : ${student.roll_no}</h6></label>                               
                            </c:forEach>
                                </center>
                            </div>
                            <br>
