            ...
            <div class="row">
                <div class="col-2 col-md-2">
                    ...
                    <div class="list-group">
                        ...
                        <a href="notice-Board.htm" class="list-group-item list-group-item-action active">Notice Board</a>
                        <a href="search_result.htm" class="list-group-item list-group-item-action">Search Result</a>
                        <a href="teachers_info" class="list-group-item list-group-item-action">Teachers Information</a>
