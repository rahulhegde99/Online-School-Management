            ...
            <div class="row">
                <div class="col-2 col-md-2">
                    ...
                    <div class="list-group">
                        ...
                        <a href="students.htm" class="list-group-item list-group-item-action active">Students Information</a>
                    ...
                    <div class="container border rounded ">
                        <form class="form-group" action="" method="">
                            <c:forEach var="std" items="${student}">
                                <br/>
                                <center>
                                    <img class="img-thumbnail" style="width:200px; height:200px"  src="resource/images/${std.s_name}_${std.roll_no}.jpg" 
                                         alt="resource/images/${std.s_name}_${std.roll_no}.jpg"/>
                                </center>
                                <h6 class="modal-title">Student Id </h6>
                                <input class="form-control"  type="text" name="s_id" value="${std.s_id}"  /> 
                                <h6 class="modal-title">Student Name </h6>
                                <input class="form-control"  type="text" name="s_name" value="${std.s_name}" /> 
                                <h6 class="modal-title">roll_no </h6> 
                                <input class="form-control" type="text" name="s_id" value="${std.roll_no}" /> 
                                <h6 class="modal-title">Gender</h6> 
                                <input class="form-control" type="text" name="s_id" value="${std.gender}" /> 
                                <h6 class="modal-title">Date of Birth</h6> 
                                <input class="form-control" type="text" name="s_id" value="${std.dob}" /> 
                                <h6 class="modal-title">Age</h6> 
                                <input class="form-control" type="text" name="s_id" value="${std.age}" /> 
                                <h6 class="modal-title">father Name</h6> 
                                <input class="form-control" type="text" name="s_id" value="${std.f_name}"/> 
                                <h6 class="modal-title">Mother Name</h6> 
                                <input class="form-control" type="text" name="s_id" value="${std.m_name}" /> 
                                <h6 class="modal-title">Mobile No</h6> 
                                <input class="form-control" type="text" name="s_id" value="${std.mobile_no}" /> 
                                <h6 class="modal-title">Present Address</h6> 
                                <textarea class="form-control" type="text" name="s_id" >${std.present_address}</textarea> 
                                <h6 class="modal-title">Permanent Address</h6> 
                                <textarea class="form-control" type="text" name="s_id" >${std.Permanent_address} </textarea>
                                <br/>
                                <input type="submit" value="Update"/> <input type="button" value="Delete"/>
                            </c:forEach>
                        </form>
                    </div>
